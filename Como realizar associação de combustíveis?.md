### Como realizar a associação de combustíveis? 
...
##### 2. Clique no modulo combustível, depois clique na aba cadastro de produtos.
...
##### 3. Realize a configuração do lógico no modulo que deseja transacionar os cartões de combustível ou benefícios após isso, acesse o configurador sitef.
...
##### 4. Informe o Código do Produto e a Descrição conforme a tabela da adquirente, enviada para o email do suporte(suportetef@elgin.com.br).
...
##### 5. Clique em Incluir após adicionar todos os códigos do produto e a descrição, clique em incluir.
...
##### 7. Clique em Associação Combustível, selecione a Empresa, selecione o Modulo, depois clique em Incluir.
...
##### 8. Associe os produto da loja conforme a planilha enviada anteriormente depois, clique em incluir, realize o processo até incluir todos os produtos e ao final, clique em Salvar.
...
##### 8. Ao final do processo, deve ser exibida a lista completa dos produtos.
